...
if(isset($_POST['demandeModif'])) {
	...
	for($i=1;$i<=$_POST['nbrEtapes'];$i++) {
	 ...
	 $sql='UPDATE recette SET titre=:titre,tpsPrep=:tpsPrep,tpsCui=:tpsCui,diff=:diff,cout=:cout,ustensile=:ustensile,calorie=:calorie,video=:video,'.$sqlEtapes.' WHERE id=:numRecette';
