        ...
        <footer>
            <div class="footer__container">
                <ul>
                    ...
                    <li class="footer__icon" onclick="afficherCategorie(5);"><span class="icon-salt-and-pepper"></li>
                    <li class="footer__icon" id="footer__last-icon"onclick="afficherCategorie(6);" id="afficherSearch"><span class="icon-magnifying-glass"></li>
                </ul>
            </div>
        </footer>
